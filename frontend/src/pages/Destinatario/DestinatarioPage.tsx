import { useDestinatarios } from '@/api/hooks/useDestinatarios';
...
export function DestinatarioPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Destinatarios</h1>
      {items && items.length > 0 ? (
        ...
        <p className="text-gray-500">No destinatarios yet.</p>
      )}
    </div>
  );
}
